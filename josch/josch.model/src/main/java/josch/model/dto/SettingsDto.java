...
public class SettingsDto extends AbstractDto {
  ...
  /** The path to the Klettke extraction tool */
  private String klettkePath;

  /**
   * The path to the Frozza extraction tool
   */
  private String frozzaPath;

  /**
   * The path to the Spoth extraction tool
   */
  private String spothPath;
  ...
  public String getKlettkePath() {
    return klettkePath;
  }

  public void setKlettkePath(String klettkePath) {
    this.klettkePath = klettkePath;
  }

  public String getFrozzaPath() {
    return frozzaPath;
  }

  public void setFrozzaPath(String frozzaPath) {
    this.frozzaPath = frozzaPath;
  }

  public String getSpothPath() {
    return spothPath;
  }

  public void setSpothPath(String spothPath) {
    this.spothPath = spothPath;
  }
